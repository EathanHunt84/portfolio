...
const about = document.querySelector(".aboutMeContainer");
...
window.addEventListener("scroll", ()=>{
  ...
  about.style.transform= `translateY(calc(200vh - ${offsetY}px))`
  ...
  jobTitles[0].style.transform = `translateX(calc(-300vh + ${offsetY}px))`
  jobTitles[1].style.transform = `translateX(calc(400vh - ${offsetY}px))`
  projectsTitle.style.transform = `translateY(calc(500vh - ${offsetY}px))`
  laptops[0].style.transform = `translateX(calc(590vh - ${offsetY}px))`
  laptops[1].style.transform = `translateX(calc(-730vh + ${offsetY}px))`
  laptops[2].style.transform = `translateX(calc(850vh - ${offsetY}px))`
})